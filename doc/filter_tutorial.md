...
### 0. I based most of this work on the tutorial you can find here, so, if you have any issues, I would start looking them up there. 
...
<ol type="a">
  <li> Opening Mongo DB Compass </li>
  <li>copy the following into the box under New Connection, and click Connect. 
mongodb+srv://alert_digger:WhereIsTheKN@cluster0.s0ada.mongodb.net/test </li>
  <li>To see the alerts (around 4000 of them) navigate in the left menu to the folder ZTF > lsst_800 
</li>
</ol>

<!-- (a) Opening Mongo DB Compass 
b) Copy the following into the box under New Connection, and click Connect. 
mongodb+srv://alert_digger:WhereIsTheKN@cluster0.s0ada.mongodb.net/test 
c) To see the alerts (around 4000 of them) navigate in the left menu to the folder ZTF > lsst_800 
 -->
**Tab description** 
...
<!-- a) ‘Export to language’ (recommended, as MongoDB Compass is not good for saving your filters) - button next to ‘Create new +’ 
b) Save your current filter – Save button next to ‘Create new +’ 
c) Export your results as a json or csv file – click on the export button next to ‘Run’ and then choose your preferred format. 
 -->
