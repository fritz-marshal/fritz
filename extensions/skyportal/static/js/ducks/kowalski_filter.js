...
export const FETCH_FILTER_VERSION_ERROR = 'skyportal/FETCH_FILTER_VERSION_ERROR';
...
export const EDIT_ACTIVE_FILTER_VERSION = 'skyportal/EDIT_ACTIVE_FILTER_VERSION';
export const EDIT_ACTIVE_FILTER_VERSION_OK = 'skyportal/EDIT_ACTIVE_FILTER_VERSION_OK';

export const EDIT_ACTIVE_FID_FILTER_VERSION = 'skyportal/EDIT_ACTIVE_FID_FILTER_VERSION';
export const EDIT_ACTIVE_FID_FILTER_VERSION_OK = 'skyportal/EDIT_ACTIVE_FID_FILTER_VERSION_OK';
